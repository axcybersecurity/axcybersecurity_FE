  ...
  return (
    <div className="p-6 sm:p-8 md:p-12 font-['Pretendard']">
        ...
        <section className="mt-10">
          ...
          {/* 텍스트 영역 (폭 통일) */}
          <div className="mt-[3vh] mx-auto max-w-3xl">
            <h4 className="text-xl sm:text-2xl font-bold text-[#043A6F] break-keep">
              AI 기반 드론 탐지 연구
            </h4>
            ...
            <div className="mt-6 text-sm sm:text-base leading-relaxed text-[#282828] space-y-1">
