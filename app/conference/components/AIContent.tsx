    ...
    <section className="conference-container">
      <div className="conference-list">
        {aiConferences.map((conference) => (
          <article key={`${conference.name}-${conference.deadline.label}`} className="conference-item">
            ...
            <div className="conference-right">
              <p className="conference-deadline">
                <strong>Deadline:</strong> {conference.deadline.label}
              </p>

              <p className="conference-countdown">
                <strong>Countdown:</strong> {getCountdown(conference.deadline.date)}
              </p>
            </div>
          </article>
        ))}
