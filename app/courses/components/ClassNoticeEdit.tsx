...
interface ClassNoticeEditProps {
  notice: Notice;
  onBack: () => void;
  onSave?: () => void;
}

export default function ClassNoticeEdit({ notice, onBack, onSave }: ClassNoticeEditProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await classNoticeApi.updateNotice(
        notice.id,
        {
          title: title.trim(),
  ...
  return (
    <div className="py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h2 className="text-4xl font-semibold text-[#02162E] mb-6">공지사항 수정</h2>
